...
<?php include '../sidebar.php'; ?>
            ...
            <div class="quick-card card">
                <div class="card-body">
                    <div class="dataTables_wrapper">
                        <table class="table table-striped" id="ajax_datatable" data-jsonfile="withdrawals.php" data-order-col="5">
                            <thead>
                            <tr>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="deleteWithdrawals"
    ...
    <script>
        var QuickMenu = {"page":"withdrawals"};
    </script>
