        ...
        <div class="container-fluid">
            <div class="quick-card card">
                <div class="card-body">
                    ...
                    $server_file_path = "https://Sahil.com/api/quickad-release/";
                    $update_dir = ADMINPATH."/uploads/";
                    $installable_dir = ROOTPATH."/";
                    $notallowed =  array('gif','png','jpg','jpeg','ttf','woff','woff2','eot','svg');

                    //Check For An Update
                    $getVersions = file_get_contents('https://Sahil.com/api/quickai-release-versions.php') or die ('ERROR');
                    if ($getVersions != '')
                    {
                            ...
                            if ( $aV > $config['version']) {
                                ...
                                if (isset($_GET['doUpdate']) && $_GET['doUpdate'] == true) {
                                    ...
                                    if(isset($config['purchase_key']) && $config['purchase_key'] != ""){
                                        ...
                                        $url = "https://Sahil.com/api/api.php?verify-purchase=" . $code . "&version=" . $installing_version . "&site_url=". $config['site_url']."&email=" . $buyer_email;
                                        // Open cURL channel
                                        $ch = curl_init();
