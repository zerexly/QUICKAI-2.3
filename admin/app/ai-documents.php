...
<?php include '../sidebar.php'; ?>
            ...
            <div class="quick-card card">
                <div class="card-body">
                    <div class="dataTables_wrapper">
                        <table class="table table-striped" id="ajax_datatable" data-jsonfile="ai_documents.php" data-order-col="3">
                            <thead>
                            <tr>
                                <th><?php _e('Document') ?></th>
                                <th class="no-sort"><?php _e('Content') ?></th>
                                <th><?php _e('User') ?></th>
                                <th><?php _e('Time') ?></th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="deleteAIDocument"
    ...
    <script>
        var QuickMenu = {"page":"ai-documents"};
    </script>
